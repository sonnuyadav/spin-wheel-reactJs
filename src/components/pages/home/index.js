  ...
  render() {
    ...
    return (
      ...
      <div><span><strong>Enter Player Name: </strong></span>
       <input type="text" id="input" value={this.state.name} onChange={ e => this.setState({name: e.target.value})} className={this.state.name == "" ? "borderRed":""} placeholder="Please add name before spin"/>
       <br/>
       <br/>
